  ...
  const connectWallet = async () => {
    ...
    if (provider) {
      try {
        ...
        if (role === 'bank') {
          navigate('/cdbank', { state: { walletAddress: address } });
        } else if (role === 'client') {
          navigate('/cdclient', { state: { walletAddress: address } });
        }
      } catch (error) {
  ...
  return (
    <div className="app-container">
      ...
      <div className="content-container">
        ...
        <h1 className="title">AIFT Aequitas Tokenized Asset Platform</h1>
        ...
        <div className="aift-select-container">
          ...
          >
            <Option value="bank" style={{ textAlign: 'center', fontSize: '18px' }}>Bank</Option>
            <Option value="client" style={{ textAlign: 'center', fontSize: '18px' }}>Client</Option>
          </Select>
        </div>
